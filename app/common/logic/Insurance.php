 ...
 * 保险逻辑
 */
class Insurance extends LogicBase
{
...
/** * **********保险订单信息start************************************************************************** * */
     ...
     * 生成保险订单
     */
    public function insuranceOrderCreate($param = []){
        ...
        $order_data = [
            ...
            'baby_id'=>intval($param['baby_id']),
            'insurance_id'=>intval($param['insurance_id']),
            'pay_money'=>$insurance['price'],
            'pay_limit'=>$insurance['pay_limit'],
            'step'=>0, // 默认是生成订单
            'gy_policy_id'=>'',
            'create_time'=>time()
        ];
        ...
        $policy_data = [
            ...
            'relationship_to_baby'=>intval($param['relationship_to_baby']),
            'baby_id'=>intval($param['baby_id']),
            ...
            'relationship_to_user'=>intval($param['relationship_to_user'])
        ];
